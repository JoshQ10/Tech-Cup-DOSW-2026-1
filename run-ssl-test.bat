@echo off
echo ============================================
echo    🚀 SERVIDOR HTTPS/SSL CON SWAGGER
echo ============================================
echo.
echo 📍 Una vez iniciado, navega a:
echo    https://localhost:8443 (Página principal)
echo    https://localhost:8443/swagger-ui.html (Swagger UI)
echo.
...
echo    - https://localhost:8443/swagger-ui.html (Documentación API)
echo    - https://localhost:8443/api-docs (JSON OpenAPI)
echo.
