...
class TournamentServiceImplTest {
        ...
        void changeStatusSuccess() {
                ...
                TournamentResponse expected = TournamentResponse.builder().id(1L).status(TournamentStatus.ACTIVE)
                                .build();
        ...
        void setupSuccess() {
                TournamentSetupRequest setupRequest = TournamentSetupRequest.builder()
                                ...
                                .schedule(List.of(
                                                TournamentDateRequest.builder().description("J1")
        ...
        void getTournamentCardsSuccess() {
                UserEntity player1 = UserEntity.builder().id(1L).firstName("Juan").lastName("Pérez")
                                .username("juan.perez").build();
                TeamEntity team1 = TeamEntity.builder().id(10L).name("Equipo A").build();
                MatchEntity match1 = MatchEntity.builder().id(100L).matchDate(LocalDate.of(2026, 4, 10))
                                .matchTime(LocalTime.of(14, 0)).build();
                ...
                when(tournamentRepository.existsById(1L)).thenReturn(true);
                when(matchEventRepository.findTournamentEventsByTypesOrderByChronology(1L,
        ...
        void getTournamentCardsRedCard() {
                UserEntity player1 = UserEntity.builder().id(2L).firstName("Carlos").lastName("García")
                                .username("carlos.garcia").build();
                MatchEntity match1 = MatchEntity.builder().id(101L).matchDate(LocalDate.of(2026, 4, 11))
                                .matchTime(LocalTime.of(15, 30)).build();
        ...
        void getTournamentCardsNullPlayer() {
                MatchEntity match1 = MatchEntity.builder().id(102L).matchDate(LocalDate.of(2026, 4, 12))
                                .matchTime(LocalTime.of(16, 0)).build();
        ...
        void getTournamentTopScorersSuccess() {
                UserEntity player1 = UserEntity.builder().id(1L).firstName("Juan").lastName("Pérez")
                                .username("juan.perez").avatarUrl("http://avatar.jpg").build();
                UserEntity player2 = UserEntity.builder().id(2L).firstName("Carlos").lastName("García")
                                .username("carlos.garcia").avatarUrl("http://avatar2.jpg").build();
                TeamEntity team1 = TeamEntity.builder().id(10L).name("Equipo A").build();
                TeamEntity team2 = TeamEntity.builder().id(11L).name("Equipo B").build();

                MatchEventEntity goal1 = MatchEventEntity.builder().id(1L).eventType(MatchEventType.GOAL)
                                .player(player1).team(team1).build();
                MatchEventEntity goal2 = MatchEventEntity.builder().id(2L).eventType(MatchEventType.GOAL)
                                .player(player1).team(team1).build();
                MatchEventEntity goal3 = MatchEventEntity.builder().id(3L).eventType(MatchEventType.GOAL)
                                .player(player2).team(team2).build();
        ...
        void getTournamentTopScorersNullPlayer() {
                ...
                MatchEventEntity goalWithPlayer = MatchEventEntity.builder().id(1L).eventType(MatchEventType.GOAL)
                                .player(player1).team(team1).build();
                MatchEventEntity goalWithoutPlayer = MatchEventEntity.builder().id(2L).eventType(MatchEventType.GOAL)
                                .player(null).team(team1).build();
        ...
        void getTournamentTopScorersUpdateTeam() {
                ...
                MatchEventEntity goal1 = MatchEventEntity.builder().id(1L).eventType(MatchEventType.GOAL)
                                .player(player1).team(null).build();
                MatchEventEntity goal2 = MatchEventEntity.builder().id(2L).eventType(MatchEventType.GOAL)
                                .player(player1).team(team1).build();
        ...
        void getTournamentMonthlyPerformanceSuccess() {
                ...
                List<TournamentMonthlyPerformanceResponse> result = tournamentService
                                .getTournamentMonthlyPerformance(1L);
        ...
        void getTournamentMonthlyPerformanceNotFound() {
                ...
                assertThrows(ResourceNotFoundException.class,
                                () -> tournamentService.getTournamentMonthlyPerformance(99L));
        }
        ...
        void confirmTournamentRulesCreateNew() {
                ...
                when(tournamentRulesConfirmationRepository.findByTournamentIdAndUserId(1L, 1L))
                                .thenReturn(Optional.empty());
                when(tournamentRulesConfirmationRepository.save(any(TournamentRulesConfirmationEntity.class)))
                                .thenReturn(savedConfirmation);
        ...
        void confirmTournamentRulesUpdate() {
                ...
                when(userRepository.findByEmail("user@example.com")).thenReturn(Optional.of(user));
                when(tournamentRulesConfirmationRepository.findByTournamentIdAndUserId(1L, 1L))
                                .thenReturn(Optional.of(existingConfirmation));
                when(tournamentRulesConfirmationRepository.save(any(TournamentRulesConfirmationEntity.class)))
        ...
        void confirmTournamentRulesNotFound() {
                ...
                assertThrows(ResourceNotFoundException.class,
                                () -> tournamentService.confirmTournamentRules(99L, "user@example.com"));
        }
        ...
        void confirmTournamentRulesUserNotFoundByEmail() {
                ...
                assertThrows(ResourceNotFoundException.class,
                                () -> tournamentService.confirmTournamentRules(1L, "nonexistent@example.com"));
        }
