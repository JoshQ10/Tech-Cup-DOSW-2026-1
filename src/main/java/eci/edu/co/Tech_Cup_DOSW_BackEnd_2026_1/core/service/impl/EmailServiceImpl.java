...
public class EmailServiceImpl implements EmailService {
    ...
    @Override
    public void sendVerificationEmail(String email, String firstName, String lastName, String token, UserType userType) {
        try {
    ...
    @Override
    public void sendVerificationEmailResend(String email, String firstName, String lastName, String token, UserType userType) {
    ...
    private String buildVerificationEmailContent(String firstName, String lastName, String token, UserType userType, String email) {
