...
@NoArgsConstructor
@AllArgsConstructor
@Schema(description = "Request para crear un nuevo torneo")
public class TournamentRequest {

    @Schema(description = "Nombre del torneo", example = "Torneo Fútbol 2026-1", requiredMode = Schema.RequiredMode.REQUIRED)
    private String name;
