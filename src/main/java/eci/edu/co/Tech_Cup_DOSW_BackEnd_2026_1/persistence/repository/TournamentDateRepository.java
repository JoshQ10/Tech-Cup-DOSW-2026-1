...
@Repository
public interface TournamentDateRepository extends JpaRepository<TournamentDateEntity, Long> {
    List<TournamentDateEntity> findByTournamentId(Long tournamentId);
}
